package backendworkflow.backend.auth.config;
 ...
 * - Sesiones stateless (no se crea HttpSession)
 * - Endpoints /api/auth/** son públicos
 * - Todo lo demás requiere autenticación vía JWT
 * - BCrypt como encoder de contraseñas
 * - EnableMethodSecurity para usar @PreAuthorize en controllers futuros
 */
@Configuration
@EnableWebSecurity
